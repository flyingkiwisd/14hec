    ...
    <div className="max-w-6xl">
      ...
      <div className="grid grid-cols-4 gap-3 mb-8">
        ...
        {[
          ...
          <button
            key={stat.label}
            onClick={() => navigate({ view: stat.view })}
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={() => navigate({ view: 'hmbs' })} className="btn-ghost text-xs">
            Explore all {'\u2192'}
          </button>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        ...
        {featuredPlant && (
          <button
            onClick={() => navigate({ view: 'plant-detail', id: featuredPlant.id })}
        ...
        {/* Quick action */}
        <button
          onClick={() => navigate({ view: 'crossref' })}
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        {[
          ...
          <button
            key={feature.view}
            onClick={() => navigate({ view: feature.view })}
      ...
      <div className="mb-8">
        <button
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(245, 158, 11, 0.05) 0%, rgba(13, 12, 20, 0.85) 40%, rgba(124, 94, 237, 0.03) 100%)',
