...
export default function AilmentDetail({ id, navigate }: AilmentDetailProps) {
  const [ailment, setAilment] = useState<AilmentDetailType | null>(null)

  useEffect(() => {
    window.api.getAilmentById(id).then(setAilment)
  }, [id])
  ...
  return (
    <div className="max-w-4xl animate-fade-in">
      <button
        onClick={() => navigate({ view: 'ailments' })}
            ...
            {ailment.plantRecommendations.map((rec, i) => (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <button
                    onClick={() => navigate({ view: 'plant-detail', id: rec.plant_id })}
          ...
          <div className="space-y-3">
            {ailment.plantsToAvoid.map((plant, i) => (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <button
                    onClick={() => navigate({ view: 'plant-detail', id: plant.plant_id })}
